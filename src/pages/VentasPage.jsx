                    ...
                    {esSel && (
                      <div className={styles.inline}>
                        ...
                        <button onClick={confirmar} className={styles.inlineConfirm}>
                          {cantInput && parseInt(cantInput) > 0 ? 'Añadir ' + cantInput + ' uds' : 'Quitar del ticket'}
                        </button>
                      </div>
                    )}
                  </div>
            ...
            <table style={{ width: '100%', borderCollapse: 'collapse', fontSize: 13 }}>
              ...
              <tbody>{historial.map(v => (
                <tr key={v.id} style={{ borderBottom: '1px solid var(--bor)' }}>
                  ...
                  <td style={{ padding: '9px 11px', fontSize: 11, color: 'var(--txt2)' }}>{(v.items || []).map(i => i.icono + i.nombre
